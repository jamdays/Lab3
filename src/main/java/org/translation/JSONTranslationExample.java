...
public class JSONTranslationExample {
    ...
    public String getCountryNameTranslation(String countryCode, String languageCode) {
        ...
        while (true) {
            ...
            else if (jsonArray.getJSONObject(i1).getString("alpha3").equals(countryCode)
                    && !jsonArray.getJSONObject(i1).isNull(languageCode)) {
                return jsonArray.getJSONObject(i1).getString(languageCode);
            }
            i1++;
        }
